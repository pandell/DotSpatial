...
namespace DotSpatial.Compatibility
{
    ...
    public interface ILayerOld
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether or not to draw the fill for a polygon shapefile.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the layer's coloring scheme is expanded in the legend.
        /// </summary>
        bool Expanded { get; set; }

        /// <summary>
        /// Gets the extents of this layer.
        /// </summary>
        Envelope Extents { get; }

        /// <summary>
        /// Gets the fileName of this layer. If the layer is memory-based only it may not have a valid fileName.
        /// </summary>
        string FileName { get; }
        ...
        /// <summary>
        /// Gets the <c>MapWinGIS.Grid</c> object associated with the layer. If the layer is not a
        ...
        /// <summary>
        /// Gets or sets the layer handle of this layer. The DotSpatial automatically sets the <c>LayerHandle</c> for the layer, and it cannot be reset.
        /// </summary>
        int Handle { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to skip over the layer when drawing the legend.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the distance from the label point to the text for the label in pixels.
        /// </summary>
        int LabelsOffset { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether labels are scaled for this layer.
        /// </summary>
        bool LabelsScale { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether labels are shadowed for this layer.
        /// </summary>
        bool LabelsShadow { get; set; }

        /// <summary>
        /// Gets or sets the color of the labels shadows.
        /// </summary>
        Color LabelsShadowColor { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether labels for this layer should be visible.
        /// </summary>
        bool LabelsVisible { get; set; }

        /// <summary>
        /// Gets the type of this layer. Valid values are:
        /// <list type="bullet">
        /// <item>Grid</item>
        /// <item>Image</item>
        /// <item>Invalid</item>
        ...
        /// <summary>
        /// Gets or sets the width between lines for multiple-line drawing styles (e.g, doublesolid).
        /// </summary>
        ...
        /// <summary>
        /// Gets access to all shapes in the layer. Only applies to shapefile layers.
        /// </summary>
        List<IFeature> Shapes { get; }

        /// <summary>
        /// Gets or sets a value indicating whether to skip over the layer when saving a project.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether or not to use <c>DynamicVisibility</c>.
        /// </summary>
        bool UseDynamicVisibility { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether mapWinGIS ocx will hide labels which collide with already drawn labels or not.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to use transparency on an <c>Image</c> layer.
        /// </summary>
        bool UseTransparentColor { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the vertices of a line or polygon are visible. This doesn't apply to line shapefiles.
        /// </summary>
        ...
        /// </summary>
        /// <returns>The underlying object as IDataset.</returns>
        IDataSet GetObject();
        ...
        /// </summary>
        /// <returns>If the file isn't found, false is returned.
        /// Function call is ignored and returns false if the layer is a grid.</returns>
        ...
        /// Function call is ignored and returns false if the layer is a grid.
        /// </summary>
        /// <param name="loadFromFilename">File from which the properties get loaded.</param>
        /// <returns>Returns false if the layer is a grid.</returns>
        ...
        /// </summary>
        /// <param name="saveToFilename">Name of the file to which the properties should be saved.</param>
        /// <returns>False, if the layer is a grid.</returns>
