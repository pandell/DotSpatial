...
namespace DotSpatial.Data.Tests
{
    ...
    public class GeometryTests
    {
        ...
        /// <summary>
        /// Makes sure that overlaps does not throw if a feature is used that has to equal xy values in a row.
        /// </summary>
        [Test(Description = @"https://github.com/DotSpatial/DotSpatial/issues/746")]
        public void OverlapWith2XyEqualCoordinatesInARow()
        {
            var cList1 = new List<CoordinateZ>
                         {
            ...
            var cList2 = new List<CoordinateZ>
                         {
        ...
        /// <summary>
        /// Checks that the resulting binary array doesn't have 4 unnecessary 0 bytes at the end.
        /// </summary>
